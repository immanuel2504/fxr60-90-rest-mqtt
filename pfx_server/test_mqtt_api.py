...
WRITE_OPS = {
    "set_appled", "set_stackled", "set_gpo", "set_hostName",
    ...
    "set_dataToRG", "set_autostartUserapp", "set_passthru",
    "set_reqToUserapp", "start", "stop",
    "set_startUserapp", "set_stopUserapp", "set_preSelection",
    "set_displayConfig",
}
DANGER_OPS = {
    "reboot", "set_os", "set_revertbackOS", "set_password", "set_network",
    "set_importCloudConfig", "set_config", "set_updateCertificate", "set_refreshCertificate",
    "del_certificate", "set_InstallCACertificate", "del_CACertificate",
    "set_installUserapp", "set_uninstallUserapp", "del_logs_syslog", "del_logs_radioPacketLog",
}
