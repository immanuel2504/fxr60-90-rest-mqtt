...
| `response/full_configuration.json` | response | `full_configuration` | `cloud-config/GET/full_configuration.json` | Full configuration (MQTT endpoints, GPIO-LED unset) |
