# `/cloud/supportedRegionList`

- **GET** - Retrieves the supported region list based on the reader type (`getSupportedregionlist`)
...
curl -sk -X GET "https://$READER/cloud/supportedRegionList" \
...
Then run `python ../validate_pack.py cloud-supportedregionlist`.
