...
- **GET** - Retrieves available Wi-Fi networks (`getAvailablewifinetworks`)
...
curl -sk -X GET "https://$READER/cloud/wifiNetworks" \
...
Then run `python ../validate_pack.py cloud-wifinetworks`.
