# Example summary titles — `/cloud/start`

## PUT request

### `PUT/start_Inventory.json`
...
| Field | Value |
|---|---|
| **Example name** | `start_Inventory with AutoStart` |
| **Summary title** | `Start inventory with AutoStart` |

### `PUT/start_Inventory_with_ImpinjGen2X.json`
