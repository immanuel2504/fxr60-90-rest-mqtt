...
- **PUT** - Updates the local REST login password (`updatePassword`)

2 example(s) exported from the spec, 0 proposed.
...
|---|---|---|---|---|---|---|
| `PUT/password.json` | PUT | request | `password` | in-spec | yes |  |
| `PUT/password_rfidadm.json` | PUT | request | `password_rfidadm` | in-spec | yes |  |
...
curl -sk -X PUT "https://$READER/cloud/updatePassword" \
...
Then run `python ../validate_pack.py cloud-updatepassword`.
