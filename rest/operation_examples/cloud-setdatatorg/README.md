...
- **PUT** - Set Data to RG (`setDataToRG`)
...
|---|---|---|---|---|---|---|
| `PUT/dataToRG.json` | PUT | request | `dataToRG` | in-spec | yes |  |
...
curl -sk -X PUT "https://$READER/cloud/setdataToRG" \
...
Then run `python ../validate_pack.py cloud-setdatatorg`.
