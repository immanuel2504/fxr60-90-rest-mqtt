...
- **PUT** - Uninstall User Application (`setUninstalluserapp`)
...
|---|---|---|---|---|---|---|
| `PUT/uninstallUserapp.json` | PUT | request | `uninstallUserapp` | in-spec | yes |  |
...
curl -sk -X PUT "https://$READER/cloud/apps/mylogger/uninstall" \
  -H "Authorization: Bearer $TOKEN" \
  -H "Content-Type: application/json" \
  -d @PUT/uninstallUserapp.json
...
Then run `python ../validate_pack.py cloud-apps-appname-uninstall`.
